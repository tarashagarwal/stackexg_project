...
ActiveRecord::Schema.define(version: 2020_05_29_184312) do
  ...
  create_table "product_resturants", force: :cascade do |t|
    t.integer "resturant_id", null: false
    t.integer "product_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_product_resturants_on_product_id"
    t.index ["resturant_id"], name: "index_product_resturants_on_resturant_id"
  end
  ...
  create_table "resturants", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["active"], name: "index_resturants_on_active"
    t.index ["code"], name: "index_resturants_on_code", unique: true
  end
